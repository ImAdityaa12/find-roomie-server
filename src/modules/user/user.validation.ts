...
import {
    NewUserPreferences,
    OnboardV1PreferencesBody,
    OnboardV1ListingBody,
    OnboardV2Body,
} from './types.ts';
...
export function validateOnboardV1PreferencesBody(
    body: Partial<OnboardV1PreferencesBody>
): string | null {
    if (!body.city) return 'city is required';
    if (body.budgetMin == null) return 'budgetMin is required';
    if (body.budgetMax == null) return 'budgetMax is required';
    ...
    const enumChecks: [keyof OnboardV1PreferencesBody, readonly string[]][] = [
        ['leaseDuration', leaseDurationEnum.enumValues],
        ['workSchedule', workScheduleEnum.enumValues],
        ['sleepSchedule', sleepScheduleEnum.enumValues],
        ['cleanliness', cleanlinessEnum.enumValues],
...
export function validateOnboardV1ListingBody(
    body: Partial<OnboardV1ListingBody>
): string | null {
    ...
    const enumChecks: [keyof OnboardV1ListingBody, readonly string[]][] = [
...
export function validateOnboardV2Body(
    body: Partial<OnboardV2Body>
): string | null {
    if (!body.city) return 'city is required';
    if (!body.locality) return 'locality is required';
    if (body.budgetMin == null) return 'budgetMin is required';
    if (body.budgetMax == null) return 'budgetMax is required';
